<?php
     ...
     * @subpackage  Envato Authorization Section
...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework_extension_envato_auth' ) ) {


        /**
         * Main ReduxFramework_extension_envato_auth extension class
         *
         * @since       1.0.0
         */
        class ReduxFramework_extension_envato_auth {
